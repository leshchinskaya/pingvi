...
Нажмите скрепку в поле ответа или чате и выберите один или несколько файлов, включая скриншоты. Pingvi добавит в текст просьбу прочитать файлы с их локальными путями. Ссылки сохраняются вместе с черновиком; чтобы убрать вложение, удалите соответствующую строку.
...
Создайте пространство кнопкой рядом с фильтром над списком диалогов. Через контекстное меню диалога → **Рабочее пространство** добавьте в него сессии Claude и Codex, относящиеся к одной задаче. Каждый диалог принадлежит одному пространству; общий список по-прежнему показывает все диалоги.
