...
![Очередь Pingvi: вопрос агента, варианты ответа и статусы других сессий](docs/media/dashboard.png)
...
![Плавающая карточка Pingvi с вопросом и вариантами ответа поверх демонстрационного редактора](docs/media/floating-question.png)
