...
**0.7.0 beta 8**: поиск по переписке, контекст перед вопросом, личные заметки, скриншоты через ⌘V, шаблоны ответов и обзор готовых результатов. Скриншоты выше показывают интерфейс beta 5.

**[Скачать Pingvi 0.7.0 beta 8 — DMG для Apple Silicon](https://github.com/leshchinskaya/pingvi/releases/download/v0.7.0-beta.8/Pingvi-0.7.0-beta.8-arm64.dmg)**
...
Готовый образ `dist/Pingvi-0.7.0-beta.8-arm64.dmg` и файл контрольной суммы `.sha256` появятся после сборки.
