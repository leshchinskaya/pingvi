...
def main():
    ...
    try:
        ...
        elif action in ('search-history', 'question-context', 'chat-history', 'chat-send', 'chat-create', 'chat-acknowledge'):
            import chat
            import maintenance
            with maintenance.guard():
                result = {'search-history': chat.search_history, 'question-context': chat.question_context, 'chat-history': chat.history, 'chat-send': chat.send, 'chat-create': chat.create, 'chat-acknowledge': chat.acknowledge}[action](data)
        elif action == 'reply':
            result = reply(data)
        elif action == 'focus':
            result = focus(data)
